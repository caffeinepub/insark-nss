...
export const idlService = IDL.Service({
  ...
  'loginCoordinator' : IDL.Func([IDL.Text, IDL.Text], [IDL.Opt(Coordinator)], []),
  'loginVolunteer' : IDL.Func([IDL.Text, IDL.Text], [IDL.Opt(Volunteer)], []),
